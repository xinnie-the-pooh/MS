========================================================================
		ActiveX Control DLL : PERSONALITYDESIGNER
========================================================================

ControlWizard has created this project for your PERSONALITYDESIGNER ActiveX Control
...
PersonalityCtl.h
	This file contains the declaration of the CPersonalityCtrl C++ class.

PersonalityCtl.cpp
	This file contains the implementation of the CPersonalityCtrl C++ class.

PersonalityPpg.h
	This file contains the declaration of the CPersonalityPropPage C++ class.

PersonalityPpg.cpp
	This file contains the implementation of the CPersonalityPropPage C++ class.

PersonalityCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CPersonalityCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file PersonalityDesigner.rc.
