...
static FUNCTION_TABLE_ENTRY g_lpFTE[] = {
    ...
    TEXT("Brush and Pens"), 0, 0, 0, NULL,
    ...
    TEXT("Device Attribute"), 0, 0, 0, NULL,
    ...
    TEXT("Device Context"), 0, 0, 0, NULL,
    ...
    TEXT("Device Object"), 0, (unsigned long) 0, 0, NULL,
