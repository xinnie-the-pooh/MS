...
{
    g_pCOtakLog->Log(OTAK_DETAIL, TEXT("In CMaskBltTestSuite::Initialize"));
    BOOL bRval = TRUE;
...
{
    g_pCOtakLog->Log(OTAK_VERBOSE, TEXT("In CMaskBltTestSuite::PreRun"));
...
CMaskBltTestSuite::Run()
{
    ...
    //g_pCOtakLog->Log(OTAK_VERBOSE, TEXT("In CMaskBltTestSuite::Run"));
...
{
    g_pCOtakLog->Log(OTAK_VERBOSE, TEXT("In CMaskBltTestSuite::AddPostRunData"));
...
{
    g_pCOtakLog->Log(OTAK_VERBOSE, TEXT("In CMaskBltTestSuite::PostRun"));
...
{
    g_pCOtakLog->Log(OTAK_DETAIL, TEXT("In CMaskBltTestSuite::Cleanup"));
