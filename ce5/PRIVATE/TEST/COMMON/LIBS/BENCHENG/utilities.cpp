...
TSTRING dtos(double d)
{
    TSTRING tsTmp;
    TCHAR tcTmp[MAXLINE];
    _sntprintf(tcTmp, ((sizeof tcTmp)/(sizeof tcTmp[0])), TEXT("%f"), d);
...
TSTRING itos(int i)
{
    TSTRING tsTmp;    
    TCHAR tcTmp[MAXLINE];
    _sntprintf(tcTmp, ((sizeof tcTmp)/(sizeof tcTmp[0])), TEXT("%d"), i);
    tcTmp[MAXLINE-1]=TEXT('\0');
    tsTmp = tcTmp;
    return tsTmp;
}
...
TSTRING itohs(int i)
{
    TSTRING tsTmp;    
    TCHAR tcTmp[MAXLINE];
    _sntprintf(tcTmp, ((sizeof tcTmp)/(sizeof tcTmp[0])), TEXT("0x%08x"), i);
    tcTmp[MAXLINE-1]=TEXT('\0');
    tsTmp = tcTmp;
    return tsTmp;
}
