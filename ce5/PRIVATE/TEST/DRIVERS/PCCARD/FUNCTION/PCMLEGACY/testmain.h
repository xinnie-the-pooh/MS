...
BOOL UpdateLegacyRegistry();
BOOL RestoreLegacytRegistry();
BOOL  AddDummyEntry(VOID);
...
extern PFN_GetSocketStatus	pfnGetSocketStatus;
extern PFN_GetSocketIndex	pfnGetSocketIndex;
extern PFN_EnumCard		pfnEnumCard;
extern PFN_EnumSocket		pfnEnumSocket;
