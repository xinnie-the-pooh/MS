...
PDEVICE_SETTING InitializeSettings(){
    ...
    //vendor id ?
    pDevSetting->uVendorId = 0x17cc;//<--USER INPUT
    //device id ?
    pDevSetting->uProductId = 0x2280;//<--USER INPUT
    ...
    //How many configurations will be exposed?
    pDevSetting->uNumofCFPresents = 1; //<--USER INPUT
