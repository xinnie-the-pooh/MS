...
typedef struct _tagTYPEDESC
    ...
    /* [switch_is][switch_type] */ union 
        {
        /* [case()] */ struct _tagTYPEDESC __RPC_FAR *lptdesc;
        /* [case()] */ DWORD reserved;
        /* [case()] */ HREFTYPE hreftype;
        /* [default] */  /* Empty union arm */ 
        }	;
...
void __RPC_STUB ITypeLib2_GetLibStatistics_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
enum tagCHANGEKIND
	...
	CHANGEKIND_MAX	= CHANGEKIND_INVALIDATE + 1
    }	CHANGEKIND;
