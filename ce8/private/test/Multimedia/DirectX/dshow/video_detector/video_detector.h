...
typedef HRESULT (STDAPICALLTYPE *PFNCOINITIALIZEEX)(LPVOID pvReserved, DWORD dwCoInit);
typedef HRESULT (STDAPICALLTYPE *PFNCOCREATEINSTANCE)(REFCLSID rclsid, LPUNKNOWN pUnkOuter, DWORD dwClsContext, REFIID riid, LPVOID * ppv);
typedef HRESULT (STDAPICALLTYPE *PFNCOUNINITIALIZE)(void);
