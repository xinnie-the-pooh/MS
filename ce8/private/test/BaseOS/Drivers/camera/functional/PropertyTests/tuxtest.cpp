...
{
    static  TCHAR   szHeader[] = TEXT("Camera Property Tests: ");
    TCHAR   szBuffer[BUFFER_LEN];

    va_list pArgs;
    va_start(pArgs, szFormat);
    _tcscpy_s(szBuffer, BUFFER_LEN, szHeader);
    _vstprintf_s(
    ...
    _tcscat_s(szBuffer, BUFFER_LEN - (_tcslen(szBuffer) + 1), TEXT("\r\n"));
...
SHELLPROCAPI ShellProc(UINT uMsg, SPPARAM spParam)
{
    ...
    case SPM_SHELL_INFO:
        ...
        CCameraDriverTest::ParseTestCommandLine(g_pShellInfo->szDllCmdLine);
