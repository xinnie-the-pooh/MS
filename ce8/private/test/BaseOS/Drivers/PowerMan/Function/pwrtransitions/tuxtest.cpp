...
SHELLPROCAPI ShellProc(UINT uMsg, SPPARAM spParam)
{
    ...
    case SPM_BEGIN_GROUP:
        ...
        // install a test driver to catch bugs in the powerup/powerdown
        // routines while suspending and resuming the system during this test
        g_pdx.StartTestDriver();
