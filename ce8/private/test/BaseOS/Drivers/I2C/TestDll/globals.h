...
GLOBAL DWORD g_dwStressTime; //ms
GLOBAL TCHAR g_strConfigFile[MAX_PATH]; // Config File Name
GLOBAL TCHAR g_strTestHook[MAX_PATH]; // Test Hook DLL Name
GLOBAL BOOL  g_bUseTestHook;

//-----------------------------------------------------------------------------
// global function pointers to the test hook DLL functions
//-----------------------------------------------------------------------------

typedef BOOL (*PFN_I2C_TEST_HOOK_INIT)();
typedef BOOL (*PFN_I2C_TEST_HOOK_DEINIT)();


static PFN_I2C_TEST_HOOK_INIT    g_pfnTestHookInit        = NULL;
static PFN_I2C_TEST_HOOK_DEINIT  g_pfnTestHookDeInit      = NULL;

static HINSTANCE  g_hTestHook      = NULL;
