...
VOID Debug(LPCTSTR szFormat, ...) {
   ...
   _vsntprintf_s((szBuffer + _tcslen(__PROJECT__ SEPARATOR)), BUFFER_SIZE, (countof(szBuffer) - (_tcslen(__PROJECT__ SEPARATOR) + 2)), szFormat, pArgs);
   va_end(pArgs);

   _tcscat_s(szBuffer, BUFFER_SIZE, TEXT("\r\n"));
