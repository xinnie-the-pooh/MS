...
BEGIN_FTE
    FTH(0, "BackgroundAnimationTestsSuite")
        FTE(1, "Ovrly bttns over anim", ID_TC_BUTTONS_OVER_ANIMATION, ID_TC_BUTTONS_OVER_ANIMATION, BackgroundAnimationPerfTest)
        FTE(1, "Ovrly/slide bttns over anim", ID_TC_SLIDING_BUTTONS_OVER_ANIMATION, ID_TC_SLIDING_BUTTONS_OVER_ANIMATION, BackgroundAnimationPerfTest)
        FTE(1, "Ovrly/slide kbrd over anim", ID_TC_SLIDING_KBRD_OVER_ANIMATION, ID_TC_SLIDING_KBRD_OVER_ANIMATION, BackgroundAnimationPerfTest)
