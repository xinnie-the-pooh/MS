...
*       05-08-02  MSL   Fix tcsnextc to deal with leadbyte,EOS. VS7 514387
*       05-20-02  MSL   Fix tclen to avoid unused var warning slightly differently;
*                       Necessitated by new compiler warning
*       05-20-02  MSL   Fix another tclen case to avoid unused var warning 
*                       slightly differently. Necessitated by new compiler warning
*                       VS7 552850
*       10-28-02  PK    Fixed the _strncnt and _wcsncnt routines (whidbey bug 2404)
*                       so that they never look past the _sz characters.
*       11-01-02  SJ    Changed the defines for _stprintf & _stprintf to call the 
*                       non-conformant versions which were renamed.(vsWhidbey#2409)
*                       Deprecated old _far text mappings (vsWhidbey#20565)
*       11-05-02  PK    Added declarations of the __strncnt and __wcsncnt functions
*       12-18-02  EAN   Added 32-bit time_t functions (VSWhidbey 6851)
*       03-06-03  SSM   Secure versions of time functions _tasctime_s, _tctime_s,
*                       _tctime64_s, _tstrdate_s, _tstrtime_s
*       03-13-03  SSM   Expose _vcprintf & _vcwprintf. VSWhidbey:2439
*       04-25-03  EAN   const-correct overloads for _tcschr, _tcspbrk, 
*                       _tcsrchr and _tcsstr (VSWhidbey#71756)
...
*       03-08-04  MSL   Removed non-existent wrapper _fgetts_nolock
*                       VSW#238783
*       03-08-04  MSL   Added missing wrapper _gettch_nolock
*                       VSW#231847
*       03-08-04  MSL   Added missing wrapper _tgetdcwd_nolock
*                       VSW#238733
*       03-08-04  MSL   Added missing wrapper _get_tpgmptr
*                       VSW#227904
*       03-08-04  MSL   Removed non-existent wrapper _istascii_l
*                       VSW#251664
*       03-08-04  MSL   Added missing wrapper _istleadbyte_l
*                       VSW#252205
*       03-08-04  MSL   Finished incomplete _istcntrl_l, _istxdigit_l and others
*                       VSW#251657
*                       VSW#245394
*       03-08-04  MSL   Added missing tcsxxx_l wrappers for many functions
*                       _tcscat[_s], _tcsncat[_s], _tcsncpy[_s], _tcsicmp
*                       _tcsncicmp, _tcsnicmp, _tcsftime, _tcscoll, _tcsicoll,
*                       _tcsnccoll, _tcsncoll, _tcsncicoll, _tcsnicoll, _tcsclen
*                       VSW#247263
*                       VSW#232715
*                       VSW#233016
*                       VSW#252188
*       03-08-04  MSL   Added missing tcsxxx[_s][_l] wrappers for many functions
*                       _tcsclen, _tcsnccat, _tcsnccpy
*                       VSW#247263
*                       VSW#232715
*                       VSW#233016
*                       VSW#252188
*       03-08-04  MSL   Added missing [str|wcs][cpy|cat][_s]_l variants that do not care about
*                       locale and so have trivial inline/macro implementations
*                       _wcsncpy[_s]_l, _wcsncat[_s]_l, _strncpy[_s]_l, _strncat[_s]_l, 
*                       VSW#232715
*       03-08-04  MSL   Added missing MBCS thunks for many functions
*       03-10-04  AC    Change name from _tcslen_s to _tcsnlen.
*                       Added _mbslwr_s and _mbsupr_s.
*       03-24-04  MSL   Added missing tchar support for _tcstok[_s][_l]
*                       VSW#245383
*       04-08-04  AC    Added _snprintf_s and _vsnprintf_s
*                       VSW#263680
*       04-10-04  MSL   NULL protection in spn[p] to help prefix/fast
...
*                       VSW#355011
*       09-22-04  AGH   Added _sctprintf_p family
*       09-24-04  MSL   Missing tcs deprecations
*       10-05-04  AC    Removed obsolete strlen_s family.
*                       VSW#379264
*       10-21-04  JL    Added missing _tcs[n]set[_s][_l] inline/macro expansions
*                       for _str and _wcs VSW#386567
*       10-02-04  AC    Add cpp overloads for secure functions.
*                       VSW#313364
*       11-18-04  ATC   SAL Annotations for CRT Headers
*       11-30-04  AC    Removed redundand #pragma warning(disable:4996)
*       01-14-05  AC    Fix SAL annotations (using prefast espx plug-in)
*       01-21-05  MSL   Add param names to overload macros
*       03-08-05  PAL   Map _stprintf_l to non-conformant UNICODE implementation
*       03-10-05  PAL   Expose _*get*_nolock API's outside _INTERNAL_IFSTRIP.
...
*                       Fixed some prefast annotations
...
*                       Added missing or incorrect redirection to str/mbs/wcs functions.
*                       VSW#565201
*       04-18-06  AC    Added __cdecl to a couple of functions declarations.
*                       VSW#588324
...
__inline void __CRTDECL _tccpy_l(_Out_ wchar_t *_Pc1, _In_z_ const wchar_t *_Cpc2, _In_opt_ _locale_t _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 25025 28719 )
    _tccpy(_Pc1, _Cpc2);
#pragma warning( pop )
}
...
__DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(wchar_t *, __RETURN_POLICY_DST, _wcsncpy_l, _wcsncpy_s_l, _Out_writes_z_(_Size) wchar_t, _Out_writes_(_Count) wchar_t, _Dst, _In_z_ const wchar_t *, _Source, _In_ size_t, _Count, _In_opt_ _locale_t, _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 4996 6054 25025 28719)
...
__DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(wchar_t *, __RETURN_POLICY_DST, _wcsncat_l, _wcsncat_s_l, _Inout_updates_z_(_Size) wchar_t, _Inout_z_ wchar_t, _Dst, _In_z_ const wchar_t *, _Source, _In_ size_t, _Count, _In_opt_ _locale_t, _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 4996 6054 6059 25025 28719 )
...
{
#pragma warning(push)
#pragma warning(disable:4996 25025)
...
__DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(char *, __RETURN_POLICY_DST, _strncpy_l, _strncpy_s_l, _Out_writes_z_(_Size) char, _Out_writes_(_Count) char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _Count, _In_opt_ _locale_t, _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 4996 25025 28719 )
