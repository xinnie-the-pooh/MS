...
*
*Revision History:
*       10-07-02 GB     Added this file.
*       03-12-04 AJS    Added prototypes for the _np forms of the interlocked intrinsics
*                       as well as #defines to map the non _np intrinsics to the _np forms if _NO_PREFETCHW is defined.
*                       Added extern "C" for C++ code.
*                       Changed bool to C-compatible types matching p1intrin.h (VSWhidbey:261356).
*                       Excluded *vec.h headers unless compiling as C++.
*                       Added const where necessary to match declarations in other files.
*       04-07-04  MSL   Double slash removal
*       04-10-04  AJS   Removed intrinsics under /clr:pure
*       08-03-04  SJ    Added const return for memchr
*       09-09-04  SJ    New compiler intrinsics
*       10-16-04  MR    VSW#325030 - Some intrinsics are not available in pure
*       11-01-04  AC    Fix _bittest signature to match winnt.h one.
*                       VSW#351895
...
*                       Declaration consistency ceil
*       05-25-05  AI    First parameter of __cpuid declared int a[4]
*                 VSW#498330
*       12-20-05  PAL   Added _rdtebex (VSW#565741)
*       02-23-06  EN    Added read/write flags and debug registers (VSW#581092)
*       03-01-06  EN    Added virtualization intrinsics
*       08-18-06  MJB   Windows SDK Update Vista Beta2: Removed _interlocked and _lfetch functions now defined by winnt.h
*       08-30-06  AC    Readd _InterlockedCompareExchange64 for 32 bit x86
*       01-05-07  WL    Added volatile for _interlockedbittestandset(64) and _interlockedbittestandreset(64). DDB#51640.
*       04-04-07  PB    DDB#86159: Fixed up __MACHINExxx macro conditions.
*       01-08-08  v-pstp Added __cpuidex intrinsic (extra parameter for ecx)
*       04-20-09  lajoel Added addfs*, addgs*, incfs* and incgs* intrinsics as per item Dev10:657685
*
****/
