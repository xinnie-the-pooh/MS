...
//****************************************************************************
// CWinSequential::InitTestParameters
//
//****************************************************************************
void CWinSequential::InitTestParametersImpl()
{
    ...
    // DCOMP is only supported for FlipModel and DWM on.
    //
    ...
    RFactor Bpp16_DwmOff = m_FeatureLevelFactor * m_globalRFactorDwmOffBpp * v_dwmCompositionOff * DontUseDCOMPFactor * (rfBltModelCombo+rfFlipModelCombo) * presentFlags;
    // DWM ON - DCOMP Not Supported on Win7+8IP and below
    RFactor Bpp32_DwmOn_NoDComp = m_FeatureLevelFactor  * m_globalRFactorDwmOnBpp * v_dwmCompositionOn * DontUseDCOMPFactor * (rfBltModelCombo+rfFlipModelCombo) * presentFlags ;
    // DWM ON - DCOMP Supported, but only for FlipModel.  for Regular Windowed Presents test both blt and Flip model.
    RFactor Bpp32_DwmOn = m_FeatureLevelFactor  * m_globalRFactorDwmOnBpp * v_dwmCompositionOn * (DontUseDCOMPFactor * (rfBltModelCombo+rfFlipModelCombo) + UseDCOMPFactor * rfFlipModelCombo) * presentFlags ;
    // DWM Off - DCOMP Not Supported
    RFactor Bpp32_DwmOff = m_FeatureLevelFactor  * m_globalRFactorDwmOnBpp * dwmCompositionOff_32bpp * DontUseDCOMPFactor * ((rfBltModelCombo+rfFlipModelCombo)) * presentFlags;
