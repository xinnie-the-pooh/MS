...
string VS_365_Desc = "vs_2_x : sub is allowed in a if p0.x nop else and rep i0 break_eq c0.x, c0.y block";
string VS_365 = 
	"vs_2_x "
	"defi i0, 0, 0, 0, 0 "
	"dcl_depth v0 "
...
string VS_371_Desc = "vs_2_x : sub is allowed in a loop aL, i0 break and if_eq c0.x, c0.y nop else block";
string VS_371 = 
	"vs_2_x "
	"defi i0, 0, 0, 0, 0 "
	"dcl_depth v0 "
