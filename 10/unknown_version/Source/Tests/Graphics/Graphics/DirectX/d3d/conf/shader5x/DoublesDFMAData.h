#pragma once
// File: DoublesDFMAData.h

//////////////////////////////////////////////////////////////////////////
// Test data from here to the end.
//////////////////////////////////////////////////////////////////////////
#ifdef WGF11SHADER5X
CShader5xTest_DoubleArith::Binary64Vec2 const CShader5xTest_dfma::s_DFMASrc0[] = 
#else
#ifdef CALCDOUBLES
dataLayout  s_DFMASrc0[] = 
#endif
#endif
{           /* X */                /* Y */
    { 0x0010000000000001ull, 0x0010000000000001ull },  // negative next-to-smallest normal
    { 0x0010000000000001ull, 0x0010000000000001ull },  
    { 0x0010000000000001ull, 0x0010000000000001ull },  
    { 0x0010000000000001ull, 0x0010000000000001ull },  
    { 0x0010000000000001ull, 0x0010000000000001ull },  
    { 0x0010000000000001ull, 0x0010000000000001ull },  
...
#ifdef WGF11SHADER5X
CShader5xTest_DoubleArith::Binary64Vec2 const CShader5xTest_dfma::s_DFMASrc1[] = 
#else
#ifdef CALCDOUBLES
dataLayout  s_DFMASrc1[] = 
#endif
#endif
{
           /* X */                /* Y */
    { 0x3fe1000000000000ull, 0x3fe1000000000000ull },  // +Norm
    { 0x3fe0010000000000ull, 0x3fe0010000000000ull },  // +Norm
    { 0x3fe0008000000000ull, 0x3fe0008000000000ull },  // +Norm
    { 0x3fe0000000000008ull, 0x3fe0000000000008ull },  // +Norm
    { 0x3fe0000000001000ull, 0x3fe0000000001000ull },  // +Norm
    { 0x3fe0000000000001ull, 0x3fe0000000000001ull },  // +Norm
...
#ifdef WGF11SHADER5X
CShader5xTest_DoubleArith::Binary64Vec2 const CShader5xTest_dfma::s_DFMASrc2[] = 
#else
#ifdef CALCDOUBLES
dataLayout  s_DFMASrc2[] = 
#endif
#endif
{
           /* X */                /* Y */
...
#ifdef WGF11SHADER5X
CShader5xTest_DoubleArith::Binary64Vec2 const CShader5xTest_dfma::s_DFMARes[] = 
#else
#ifdef CALCDOUBLES
dataLayout  s_DFMARes[] = 
#endif
#endif
{
// s_DFMASrc0 * s_DFMASrc1 + s_DFMASrc2:
           /* X */                /* Y */
    { 0x0008800000000001ull, 0x0008800000000001ull },
    { 0x0008008000000001ull, 0x0008008000000001ull },
    { 0x0008004000000001ull, 0x0008004000000001ull },
    { 0x0008000000000005ull, 0x0008000000000005ull },
    { 0x0008000000000801ull, 0x0008000000000801ull },
    { 0x0008000000000001ull, 0x0008000000000001ull },
    { 0xFFF0000000000000ull, 0xFFF0000000000000ull },
    { 0x7FF0000000000000ull, 0x7FF0000000000000ull },
    { 0xFFF8000000000000ull, 0xFFF8000000000000ull },
    { 0x7FFFCB8D9A5D4659ull, 0x7FFFCB8D9A5D4659ull },
    ...
    { 0x7FF0000000000000ull, 0x7FF0000000000000ull },
    { 0xE7FEAD7B140FEF0Dull, 0xE7FEAD7B140FEF0Dull },   // Non-fused result:  a*b+c=..EF0C 
    { 0xDB10B26B4C58A7C8ull, 0xDB10B26B4C58A7C8ull },
    { 0xFFF0000000000000ull, 0xFFF0000000000000ull },
    { 0xC8D851123B5A17A7ull, 0xC8D851123B5A17A7ull },
    { 0x98B288FDC0F508D0ull, 0x98B288FDC0F508D0ull },
    ...
    { 0xA4C86674C8DFD9ACull, 0xA4C86674C8DFD9ACull },
    { 0x35049A5C33BC8EEAull, 0x35049A5C33BC8EEAull },
    { 0x59407D90AFFF3AB8ull, 0x59407D90AFFF3AB8ull },   // Non-fused result:  a*b+c=..3AB9 
    ...
    { 0x3207736F7500526Cull, 0x3207736F7500526Cull },
    ...
    { 0x2DA41B7630B8D878ull, 0x2DA41B7630B8D878ull },
    { 0x7FF0000000000000ull, 0x7FF0000000000000ull },
    ...
    { 0x000679658578EDD7ull, 0x000679658578EDD7ull },
    ...
    { 0x00ABF9C6DB3F0818ull, 0x00ABF9C6DB3F0818ull },
    { 0x8BEEAC90889823AFull, 0x8BEEAC90889823AFull },
    { 0x8633636015A4A1A2ull, 0x8633636015A4A1A2ull },
    ...
    { 0x000000000000051Dull, 0x000000000000051Dull },
    { 0xAAE20FA56D133FE4ull, 0xAAE20FA56D133FE4ull },
    ...
    { 0x15F9B6670EC4B20Aull, 0x15F9B6670EC4B20Aull },
    { 0x2413372A12FE6DA5ull, 0x2413372A12FE6DA5ull },
    { 0x000000012EFC3984ull, 0x000000012EFC3984ull },
    { 0xB3603666ACFBB2EDull, 0xB3603666ACFBB2EDull },
    ...
    { 0x000007F3DCF2706Aull, 0x000007F3DCF2706Aull },
    ...
    { 0x000000086CBA17F3ull, 0x000000086CBA17F3ull },
    ...
    { 0x80F6942E92AC1E2Full, 0x80F6942E92AC1E2Full },
    ...
    { 0x8000248028E0274Aull, 0x8000248028E0274Aull },
    ...
    { 0x80ACCF6218633579ull, 0x80ACCF6218633579ull },
    ...
    { 0x8000000000000744ull, 0x8000000000000744ull },
    ...
    { 0x8009FF4CFC5D1BCEull, 0x8009FF4CFC5D1BCEull },
    ...
    { 0x81B485411BF4A097ull, 0x81B485411BF4A097ull },
    { 0x000000000000929Full, 0x000000000000929Full },
    { 0x80000000000004E1ull, 0x80000000000004E1ull },
    { 0x00003F26ECC04867ull, 0x00003F26ECC04867ull },
    { 0x800009DE95F2AAE6ull, 0x800009DE95F2AAE6ull },
    { 0x800602511B0D275Eull, 0x800602511B0D275Eull },
    { 0x00000003013A070Full, 0x00000003013A070Full },
    { 0x018B03609C4F33A8ull, 0x018B03609C4F33A8ull },
    { 0x00000001D85FDB07ull, 0x00000001D85FDB07ull },
    { 0x808811DE5998AF32ull, 0x808811DE5998AF32ull },
    { 0x0000306D297F1F78ull, 0x0000306D297F1F78ull },
    { 0x81A7A773BAF1896Full, 0x81A7A773BAF1896Full },
    { 0x02AA31325AA18034ull, 0x02AA31325AA18034ull },
    { 0x8000000342183847ull, 0x8000000342183847ull },
    { 0x80B9C61A026B1030ull, 0x80B9C61A026B1030ull },
    { 0x0000000005EC5713ull, 0x0000000005EC5713ull },
    { 0x80000015517EE3E0ull, 0x80000015517EE3E0ull },
    { 0x80000013A977BE80ull, 0x80000013A977BE80ull },
    { 0x8005114D6EC07ABCull, 0x8005114D6EC07ABCull },
    { 0x00006A6D874C9DA1ull, 0x00006A6D874C9DA1ull },
    { 0x0000001269B0341Full, 0x0000001269B0341Full },
    { 0x0000000028532ECEull, 0x0000000028532ECEull },
    { 0x0000045A255C84E3ull, 0x0000045A255C84E3ull },
    { 0x8036FEB4CD5784A5ull, 0x8036FEB4CD5784A5ull },
    { 0x0002F865C3ACB492ull, 0x0002F865C3ACB492ull },
    { 0x00000000010EEDFFull, 0x00000000010EEDFFull },
    { 0x00000046F6CA12A1ull, 0x00000046F6CA12A1ull },
    { 0x80591A4D1C14E790ull, 0x80591A4D1C14E790ull },
    { 0x8007185ED3D8025Full, 0x8007185ED3D8025Full },
    { 0x02957CFA51C4A9BDull, 0x02957CFA51C4A9BDull },
    { 0x80000B76DFFA5197ull, 0x80000B76DFFA5197ull },
    { 0x8024DF1DB9A5F8C2ull, 0x8024DF1DB9A5F8C2ull },
    { 0x0000000C6A3BFFF7ull, 0x0000000C6A3BFFF7ull },
    { 0x0005545B4DDCE95Dull, 0x0005545B4DDCE95Dull },
    { 0x814CF7380149EDC7ull, 0x814CF7380149EDC7ull },
    { 0x8000000000077596ull, 0x8000000000077596ull },
    { 0x0001856D4ACC6EFBull, 0x0001856D4ACC6EFBull },
    { 0x80055CD74DA8F651ull, 0x80055CD74DA8F651ull },
    { 0x0000000000010615ull, 0x0000000000010615ull },
    { 0x8000000FB2A9BC6Bull, 0x8000000FB2A9BC6Bull },
    { 0x800008E04CAC4A27ull, 0x800008E04CAC4A27ull },
    { 0x8000000000354C4Bull, 0x8000000000354C4Bull },
    { 0x00F228021E7D4FDDull, 0x00F228021E7D4FDDull },
    { 0x805A126F4F2F7989ull, 0x805A126F4F2F7989ull },
    { 0x0104FC81B1E9E8E3ull, 0x0104FC81B1E9E8E3ull },
    { 0x8001D8A11CA20F7Dull, 0x8001D8A11CA20F7Dull },
    { 0x003965A721E54752ull, 0x003965A721E54752ull },
    { 0x000000000000104Eull, 0x000000000000104Eull },
    { 0x8000053E8E38F1A3ull, 0x8000053E8E38F1A3ull },
    { 0x800000003C5FE20Eull, 0x800000003C5FE20Eull },
    { 0x00D7F67BE7EA8D7Eull, 0x00D7F67BE7EA8D7Eull },
    { 0x01123FC25159AE36ull, 0x01123FC25159AE36ull },
    { 0x024527848E0BF155ull, 0x024527848E0BF155ull },
    { 0x00000000283AAD13ull, 0x00000000283AAD13ull },
    { 0x00000002FBD02B7Full, 0x00000002FBD02B7Full },
    { 0x8084186BB3EB3460ull, 0x8084186BB3EB3460ull },
    { 0x8003D526BF104510ull, 0x8003D526BF104510ull },
    { 0x0000000000000029ull, 0x0000000000000029ull },
    { 0x800000002F448848ull, 0x800000002F448848ull },
    { 0x02CFA25F73125077ull, 0x02CFA25F73125077ull },
    { 0x8000000000010231ull, 0x8000000000010231ull },
    { 0x01140EFA47B933D0ull, 0x01140EFA47B933D0ull },
    { 0x00000002A3119D68ull, 0x00000002A3119D68ull },
    { 0x004B6209EDE3E4E5ull, 0x004B6209EDE3E4E5ull },
    { 0x800035ABE19E9DD1ull, 0x800035ABE19E9DD1ull },
    { 0x8000009F0ED6E616ull, 0x8000009F0ED6E616ull },
    { 0x000000BCFABA6BB1ull, 0x000000BCFABA6BB1ull },
    { 0x800000000F6FD3EAull, 0x800000000F6FD3EAull },
    { 0x80000002CE1B103Eull, 0x80000002CE1B103Eull },
    { 0x80B6A174819BA6F9ull, 0x80B6A174819BA6F9ull },
    { 0x0001765C20BA55FBull, 0x0001765C20BA55FBull },
    { 0x000B448301C5CDB1ull, 0x000B448301C5CDB1ull },
    { 0x8008DB930D7892E4ull, 0x8008DB930D7892E4ull },
    { 0x8009BED5F5B56899ull, 0x8009BED5F5B56899ull },
    { 0x000AAFEAAE2C7514ull, 0x000AAFEAAE2C7514ull },
    { 0x000DB3D2E70E27A8ull, 0x000DB3D2E70E27A8ull },
    { 0x000D94E0DC84AA91ull, 0x000D94E0DC84AA91ull },
    { 0x800D89E2BDDC9C44ull, 0x800D89E2BDDC9C44ull },
    { 0x800DBC9A2E55F4A9ull, 0x800DBC9A2E55F4A9ull },
    { 0x8009C86AD701ACFEull, 0x8009C86AD701ACFEull },
    { 0x0019C09454F5D83Aull, 0x0019C09454F5D83Aull },
    { 0x800C1B05E915CB44ull, 0x800C1B05E915CB44ull },
    { 0x0008230A2641FCD3ull, 0x0008230A2641FCD3ull },
    ...
    { 0x8008B5F68435405Dull, 0x8008B5F68435405Dull },
    { 0x800A540AF8274636ull, 0x800A540AF8274636ull },
    { 0x8008CBE245C82CB0ull, 0x8008CBE245C82CB0ull },
    { 0x000BCC1BC0506AA0ull, 0x000BCC1BC0506AA0ull },
