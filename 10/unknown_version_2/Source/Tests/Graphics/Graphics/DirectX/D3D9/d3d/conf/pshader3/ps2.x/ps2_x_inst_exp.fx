...
TESTCASE "Exp - Pred/Mask (2) (p0.y) exp r0.y, v0.z";
	...
	TESTBEGIN
	def c1, 0.0, 1.59314215134, 0.0, 0.0
	dcl v0
	SET_PRED
	mov r0, c0.y
	mov r2, c0.w
...
TESTCASE "Exp - Pred/Mask (3) (p0.z) exp r0.z, t0.w";
	USEPREDICATE
	PASSBEGIN
...
TESTCASE "Exp - Pred/Mask (5) (!p0) exp r0.xz, t0.z";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (6) exp r0.yw, v0.w";
	PASSBEGIN
	TESTBEGIN
	def c1, 0.0, 1.97845602639, 0.0, 1.97845602639
	dcl v0
	mov r0, c0.y
	mov r2, c0.w
	exp r0.yw, v0.w
...
TESTCASE "Exp - Pred/Mask (8) (!p0.z) exp r0.xyzw, r4.x";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.z
	(!p0.z) exp r0.xyzw, r4.x
	VERIFY_RESULT
	V_X V_Y V_Z V_W
	TESTEND

TESTCASE "Exp - Pred/Mask (9) (!p0.w) exp r0, v0.y";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (10) exp r0.x, r4.z";
	PASSBEGIN
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (11) (!p0) exp r0.y, r4.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (12) (!p0.x) exp r0.z, r4.x";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (13) (p0.y) exp r0.w, r4.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (15) (p0.w) exp r0.yw, t0.x";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (16) (p0) exp r0.xyw, c4.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (17) (p0.y) exp r0.xyzw, c4.z";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.z
	(p0.y) exp r0.xyzw, c4.z
	VERIFY_RESULT
	V_X V_Y V_Z V_W
	TESTEND

TESTCASE "Exp - Pred/Mask (18) (p0.x) exp r0, t0.z";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (19) (p0.y) exp r0.x, t0.x";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (20) (!p0.z) exp r0.y, c4.x";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (21) exp r0.z, v0.y";
	PASSBEGIN
	TESTBEGIN
	def c1, 0.0, 0.0, 1.85397912508, 0.0
	dcl v0
	mov r0, c0.y
	mov r2, c0.w
	exp r0.z, v0.y
...
TESTCASE "Exp - Pred/Mask (22) (p0.z) exp r0.w, v0.y";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
	def c1, 0.0, 0.0, 0.0, 1.85397912508
	dcl v0
	SET_PRED
	mov r0, c0.y
	mov r2, c0.w
...
TESTCASE "Exp - Pred/Mask (23) (!p0.w) exp r0.xz, v0.x";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (24) (p0.z) exp r0.yw, r4.z";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (25) (p0.w) exp r0.xyw, v0.x";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.w
	(p0.w) exp r0.xyw, v0.x
	VERIFY_RESULT
	V_X V_Y V_Z V_W
	TESTEND

TESTCASE "Exp - Pred/Mask (26) exp r0.xyzw, t0.y";
	PASSBEGIN
	TESTBEGIN
	def c1, 0.290931214694, 0.290931214694, 0.290931214694, 0.290931214694
	dcl t0
...
TESTCASE "Exp - Pred/Mask (27) (p0) exp r0.x, v0.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (28) (!p0) exp r0.w, t0.z";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (29) (!p0) exp r0.yw, c4.y";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (30) exp r0.y, t0.y";
	PASSBEGIN
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (31) (p0.x) exp r0.xz, r4.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (32) (p0.x) exp r0.xyw, t0.z";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.z
	(p0.x) exp r0.xyw, t0.z
	VERIFY_RESULT
	V_X V_Y V_Z V_W
	TESTEND

TESTCASE "Exp - Pred/Mask (33) (p0.y) exp r0, c4.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (34) (!p0.y) exp r0.z, c4.z";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (35) (p0.w) exp r0.xyzw, v0.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.w
	(p0.w) exp r0.xyzw, v0.w
	VERIFY_RESULT
	V_X V_Y V_Z V_W
	TESTEND

TESTCASE "Exp - Pred/Mask (36) (!p0.y) exp r0.xz, r4.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (37) (!p0.y) exp r0.yw, t0.x";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (38) exp r0.w, c4.z";
	PASSBEGIN
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (39) (!p0.x) exp r0.xyzw, v0.z";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
	def c1, 1.59314215134, 1.59314215134, 1.59314215134, 1.59314215134
	dcl v0
	SET_PRED
	mov r0, c0.y
	mov r2, c0.w
	(!p0.x) exp r0.xyzw, v0.z
	VERIFY_RESULT
	V_X V_Y V_Z V_W
	TESTEND

TESTCASE "Exp - Pred/Mask (40) (!p0.z) exp r0, t0.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (41) (!p0.z) exp r0.x, c4.w";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (42) exp r0.xyw, v0.z";
	PASSBEGIN
	TESTBEGIN
	def c1, 1.59314215134, 1.59314215134, 0.0, 1.59314215134
	dcl v0
	mov r0, c0.y
	mov r2, c0.w
	exp r0.xyw, v0.z
...
TESTCASE "Exp - Pred/Mask (43) (p0.w) exp r0.y, v0.y";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
	def c1, 0.0, 1.85397912508, 0.0, 0.0
	dcl v0
	SET_PRED
	mov r0, c0.y
	mov r2, c0.w
...
TESTCASE "Exp - Pred/Mask (44) (!p0.w) exp r0.z, t0.y";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Exp - Pred/Mask (45) exp r0.yw, v0.w";
	PASSBEGIN
	TESTBEGIN
	def c1, 0.0, 1.97845602639, 0.0, 1.97845602639
	dcl v0
...
TESTCASE "Exp - Pred/Mask (46) (!p0.y) exp r0.x, t0.y";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
// End of file.  79 tests generated.