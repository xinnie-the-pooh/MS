...
TESTCASE "Crs - Pred/Mask (3) (p0.z) crs r0.xy, t0, r5";
	USEPREDICATE
	PASSBEGIN
	...
	mov r0, c0.y
	mov r2, c0.z
	(p0.z) crs r0.xy, t0, r5
	VERIFY_RESULT
	V_X V_Y V_Z
	TESTEND

TESTCASE "Crs - Pred/Mask (4) (!p0.w) crs r0.xz, r4, r5";
	USEPREDICATE
	PASSBEGIN
...
TESTCASE "Crs - Pred/Mask (6) (!p0) crs r0.xyz, t0, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (9) (!p0.w) crs r0.z, c4, v1";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (10) (!p0) crs r0.xy, v0, c5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (11) crs r0.xz, c4, v1";
	PASSBEGIN
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (12) (p0.w) crs r0.yz, r4, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.z
	(p0.w) crs r0.yz, r4, r5
	VERIFY_RESULT
	V_X V_Y V_Z
	TESTEND

TESTCASE "Crs - Pred/Mask (13) (p0.x) crs r0.xyz, r4, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (14) (p0.w) crs r0.x, v0, c5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (15) (p0.z) crs r0.y, v0, c5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (16) crs r0.z, r4, r5";
	PASSBEGIN
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (17) (p0.y) crs r0.xy, r4, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.z
	(p0.y) crs r0.xy, r4, r5
	VERIFY_RESULT
	V_X V_Y V_Z
	TESTEND

TESTCASE "Crs - Pred/Mask (18) (p0) crs r0.xz, t0, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (19) (!p0) crs r0.yz, c4, v1";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (20) (!p0.y) crs r0.xyz, c4, v1";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.w
	(!p0.y) crs r0.xyz, c4, v1
	VERIFY_RESULT
	V_X V_Y V_Z
	TESTEND

TESTCASE "Crs - Pred/Mask (21) crs r0.y, t0, r5";
	PASSBEGIN
	TESTBEGIN
	def c1, 0.0, 0.455078125, 0.0, 0.0
	dcl t0
...
TESTCASE "Crs - Pred/Mask (22) (p0.x) crs r0.x, t0, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (23) (!p0) crs r0.z, t0, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (24) (!p0.z) crs r0.xz, v0, c5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 0, 1, 0};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (25) (p0.y) crs r0.yz, t0, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.z
	(p0.y) crs r0.yz, t0, r5
	VERIFY_RESULT
	V_X V_Y V_Z
	TESTEND

TESTCASE "Crs - Pred/Mask (26) (!p0.w) crs r0.xy, c4, v1";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.w
	(!p0.w) crs r0.xy, c4, v1
	VERIFY_RESULT
	V_X V_Y V_Z
	TESTEND

TESTCASE "Crs - Pred/Mask (27) (!p0.z) crs r0.xyz, v0, c5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.w
	(!p0.z) crs r0.xyz, v0, c5
	VERIFY_RESULT
	V_X V_Y V_Z
	TESTEND

TESTCASE "Crs - Pred/Mask (28) (!p0.x) crs r0.z, v0, c5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (29) (p0.y) crs r0.x, t0, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (30) crs r0.xy, v0, c5";
	PASSBEGIN
	TESTBEGIN
	def c1, -0.72265625, 0.6962890625, 0.0, 0.0
	dcl v0
...
TESTCASE "Crs - Pred/Mask (31) crs r0.xyz, r4, r5";
	PASSBEGIN
	TESTBEGIN
	def c1, 2.1171875, 0.455078125, 1.341796875, 0.0
	mov r4, c4
...
TESTCASE "Crs - Pred/Mask (32) (!p0) crs r0.y, t0, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (33) (!p0.z) crs r0.yz, c4, v1";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 1, 0, 1};
	TESTBEGIN
	...
	mov r0, c0.y
	mov r2, c0.w
	(!p0.z) crs r0.yz, c4, v1
	VERIFY_RESULT
	V_X V_Y V_Z
	TESTEND

TESTCASE "Crs - Pred/Mask (34) (p0.x) crs r0.xz, r4, r5";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {1, 1, 1, 1};
	TESTBEGIN
...
TESTCASE "Crs - Pred/Mask (35) (!p0.x) crs r0.xz, c4, v1";
	USEPREDICATE
	PASSBEGIN
	PixelShaderConstantF[2] = {0, 0, 0, 0};
	TESTBEGIN
...
// End of file.  52 tests generated.