...
void CZCmpTest::AlwaysTests(int nTest)
{
	switch (nTest)
	{
		...
		case (3):	// Single Flat Triangles
			...
			// Red Triangle
			VertexList[dwVertexCount++] = D3DTLVERTEX(D3DVECTOR(150.0f, 40.0f,0.9999f),(1.0f / 0.9999f), RGBA_MAKE(255,0,0,255),0, 0.5f,0.0f);
			VertexList[dwVertexCount++] = D3DTLVERTEX(D3DVECTOR(240.0f,240.0f,0.9999f),(1.0f / 0.9999f), RGBA_MAKE(255,0,0,255),0, 1.0f,1.0f);
			VertexList[dwVertexCount++] = D3DTLVERTEX(D3DVECTOR( 60.0f,240.0f,0.9999f),(1.0f / 0.9999f), RGBA_MAKE(255,0,0,255),0, 0.0f,1.0f);
			break;
		case (4):	// Left Handed Non-Flat Triangles
			...
			// Green Triangle
			VertexList[dwVertexCount++] = D3DTLVERTEX(D3DVECTOR( 70.0f, 70.0f,0.0f),    (1.0f / 0.00001f), RGBA_MAKE(0,255,0,255),0, 0.0f,0.0f);
			VertexList[dwVertexCount++] = D3DTLVERTEX(D3DVECTOR(170.0f, 70.0f,0.00001f),(1.0f / 0.00001f), RGBA_MAKE(0,255,0,255),0, 1.0f,0.0f);
			...
			VertexList[dwVertexCount++] = D3DTLVERTEX(D3DVECTOR(195.0f,150.0f,0.005f),(1.0f / 0.005f), RGBA_MAKE(255,255,0,255),0, 0.75f,1.0f);
			break;
		case (5):	// Right Handed Non-Flat Triangles
			...
			// Red Triangle
			VertexList[dwVertexCount++] = D3DTLVERTEX(D3DVECTOR( 10.0f, 10.0f,0.00805f),(1.0f / 0.00805f), RGBA_MAKE(255,0,0,255),0, 0.0f,0.0f);
			...
			VertexList[dwVertexCount++] = D3DTLVERTEX(D3DVECTOR(150.0f,195.0f,0.007f), (1.0f / 0.007f),  RGBA_MAKE(255,255,0,255),0, 1.0f, 0.75f);
