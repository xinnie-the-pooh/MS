...
// Marathi keyboard
//
// Marathi and other Indic keyboards can compose multiple
// keystrokes into composed characters so be careful!
//
//  Num  VK1   VK2    Num   Unicode
testSequence KBDTests_Marathi[] = 
{
    // Without VK_SHIFT
    ...
    /* Keys 1234567890-= */
    {1, {0x31, 0x00}, 1,    0x0967},      
    {1, {0x32, 0x00}, 1,    0x0968},      
    {1, {0x33, 0x00}, 1,    0x0969},      
    {1, {0x34, 0x00}, 1,    0x096A},      
    {1, {0x35, 0x00}, 1,    0x096B},      
    {1, {0x36, 0x00}, 1,    0x096C},      
    {1, {0x37, 0x00}, 1,    0x096D},      
    {1, {0x38, 0x00}, 1,    0x096E},      
    {1, {0x39, 0x00}, 1,    0X096F},      
    {1, {0x30, 0x00}, 1,    0x0966},      
    ...
    {3, {0x0011, 0x0012, 0x0031}, 1, 0x0031},
    {3, {0x0011, 0x0012, 0x0032}, 1, 0x0032},
    {3, {0x0011, 0x0012, 0x0033}, 1, 0x0033},
    {3, {0x0011, 0x0012, 0x0034}, 1, 0x0034},
    {3, {0x0011, 0x0012, 0x0035}, 1, 0x0035},
    {3, {0x0011, 0x0012, 0x0036}, 1, 0x0036},
    {3, {0x0011, 0x0012, 0x0037}, 1, 0x0037},
    {3, {0x0011, 0x0012, 0x0038}, 1, 0x0038},
    {3, {0x0011, 0x0012, 0x0039}, 1, 0x0039},
    {3, {0x0011, 0x0012, 0x0030}, 1, 0x0030},
    /* Keys qwertyuiop[]\ */
    ...
    /* Keys zxcvbnm,./ */
    {4, {0x0010, 0x0011, 0x0012, 0x005A}, 1, 0x093D},
