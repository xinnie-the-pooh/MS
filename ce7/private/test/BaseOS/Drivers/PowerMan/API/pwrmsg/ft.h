...
BEGIN_FTE
    ...
    FTE(0, "Power Manager Notification Tests Usage Message", 1, 0, UsageMessage)

    FTH(0, "Test Power Manager Notification Messages")
    FTE(1,      "Test Notification Messages for System Power State Transitions",   FUNC_BASE + 1, 0, Tst_SysPowerStateTransitionMsg)
    FTE(1,      "Test Notification Messages for Suspend\\Resume State Transition", FUNC_BASE + 2, 0, Tst_SuspendResumeTransitionMsg)
