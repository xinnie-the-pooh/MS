...
// Global value determining how long, in ms, we will wait for power notification
GLOBAL UINT g_tNotifyWait INIT(DEF_NOTIF_TIME);

// Global value determining whether or not power function options include POWER_FORCE
GLOBAL BOOL g_fPowerForce INIT(FALSE);
