...
{
    info(ECHO, TEXT("In CRectangleTestSuite::Initialize"));
    BOOL bRval = TRUE;
...
{
    info(DETAIL, TEXT("In CRectangleTestSuite::PreRun"));
...
CRectangleTestSuite::Run()
{
    ...
    //info(DETAIL, TEXT("In CRectangleTestSuite::Run"));
...
{
    info(DETAIL, TEXT("In CRectangleTestSuite::AddPostRunData"));
...
{
    info(DETAIL, TEXT("In CRectangleTestSuite::PostRun"));
...
{
    info(ECHO, TEXT("In CRectangleTestSuite::Cleanup"));
