...
{
    info(ECHO, TEXT("In CPolylineTestSuite::Initialize"));
    BOOL bRval = TRUE;
...
{
    info(DETAIL, TEXT("In CPolylineTestSuite::PreRun"));
...
CPolylineTestSuite::Run()
{
    ...
    //info(DETAIL, TEXT("In CPolylineTestSuite::Run"));
...
{
    info(DETAIL, TEXT("In CPolylineTestSuite::AddPostRunData"));
...
{
    info(DETAIL, TEXT("In CPolylineTestSuite::PostRun"));
...
{
    info(ECHO, TEXT("In CPolylineTestSuite::Cleanup"));
