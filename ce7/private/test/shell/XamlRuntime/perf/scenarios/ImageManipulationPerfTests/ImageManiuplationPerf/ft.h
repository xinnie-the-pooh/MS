...
BEGIN_FTE
    FTH(0, "ImageManipulationPerfTestsSuite")

    // Gesture Graphics tests
        FTE(1, "Pan Graph",                TC_GRAPH_PAN,                   TC_GRAPH_PAN,                   ImageManipulationPerfTest)
        FTE(1, "Flck Graph",               TC_GRAPH_FLICK,                 TC_GRAPH_FLICK,                 ImageManipulationPerfTest)
        FTE(1, "Zoom Graph",               TC_GRAPH_ZOOM,                  TC_GRAPH_ZOOM,                  ZoomImagePerfTest)
        FTE(1, "H Scroll Graph",           TC_GRAPH_H_SCROLL,              TC_GRAPH_H_SCROLL,              ScrollImagePerfTest)
        FTE(1, "V Scroll Graph",           TC_GRAPH_V_SCROLL,              TC_GRAPH_V_SCROLL,              ScrollImagePerfTest)

        // Gesture Photo tests
        FTE(1, "Pan Photo",                TC_PHOTO_PAN,                   TC_PHOTO_PAN,                   ImageManipulationPerfTest)
        FTE(1, "Flck Photo",               TC_PHOTO_FLICK,                 TC_PHOTO_FLICK,                 ImageManipulationPerfTest)
        FTE(1, "Zoom Photo",               TC_PHOTO_ZOOM,                  TC_PHOTO_ZOOM,                  ZoomImagePerfTest)
        FTE(1, "H Scroll Photo",           TC_PHOTO_H_SCROLL,              TC_PHOTO_H_SCROLL,              ScrollImagePerfTest)
        FTE(1, "V Scroll Photo",           TC_PHOTO_V_SCROLL,              TC_PHOTO_V_SCROLL,              ScrollImagePerfTest)
