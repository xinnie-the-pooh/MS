...
#define COP1X_OP 0x13                   // coprocessor 3(COP1X) operation
...
#define DADDIU_OP 0x19                  // doubleword add immediate unsigned

#define LDL_OP 0x1a                     // load double left integer
#define LDR_OP 0x1b                     // load double right integer

#define JALX_OP 0x1d                    // jump and link exchange
...
#define DSUBU_OP 0x2f                   // doubleword subtract unsigned
...
#define COP_BC_OP 0x8                   // coprocessor bc
...
//
// Define floating coprocessor 1 COP1X opcodes.
//
#define FLOAT_MADD 4                    // floating multiply-add
#define FLOAT_MSUB 5                    // floating multiply-subtract
#define FLOAT_NMADD 6                   // floating negative multiply-add
#define FLOAT_NMSUB 7                   // floating negative multiply-subtract
...
#define FORMAT_CT 6                     // not really a format, but an extension opcode
