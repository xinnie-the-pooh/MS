...
struct object
{
    ...
    //
    bool GetProperty(LPCWSTR pszName, wstring* pValue, unsigned long nIndex = 0);
    bool GetProperty(LPCWSTR pszName, unsigned long* pValue, unsigned long nIndex = 0);
    bool GetProperty(LPCWSTR pszName, signed long* pValue, unsigned long nIndex = 0);
    bool GetProperty(LPCWSTR pszName, bool* pValue, unsigned long nIndex = 0);
    
private:
    friend class details::objects;
    details::properties* pProperties;
};
