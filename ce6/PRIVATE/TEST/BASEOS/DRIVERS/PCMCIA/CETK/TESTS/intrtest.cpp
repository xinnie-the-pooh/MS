...
//@Func VOID | InitIRQRegister | Initialize the UART registers to receive and transmit interrupts...
...
/*
@Func | VOID | StartIRQ | Enable the receive and transmit bits of IER.
*/
