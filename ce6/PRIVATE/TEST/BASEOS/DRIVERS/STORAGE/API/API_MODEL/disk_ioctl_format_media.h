...
#ifndef _DISK_IOCTL_FORMAT_MEDIA_H
#define _DISK_IOCTL_FORMAT_MEDIA_H
#include "main.h"
...
typedef class _DISK_IOCTL_FORMAT_MEDIA_TEST : public  DRIVER_TEST
{
...
public:
	_DISK_IOCTL_FORMAT_MEDIA_TEST(void){m_pKato = NULL;m_hDevice = NULL;dwDeviceType = 0;inData.dwIoControlCode = DISK_IOCTL_FORMAT_MEDIA;}
	_DISK_IOCTL_FORMAT_MEDIA_TEST(HANDLE Handle,CKato *pKato,DWORD deviceType){m_pKato = pKato;m_hDevice = Handle;dwDeviceType = deviceType;inData.dwIoControlCode = DISK_IOCTL_FORMAT_MEDIA;}
private:
...
}DISK_IOCTL_FORMAT_MEDIA_TEST,*PDISK_IOCTL_FORMAT_MEDIA_TEST;
#endif
