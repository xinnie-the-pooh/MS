...
#ifndef _IOCTL_DISK_GET_STORAGEID_H
#define _IOCTL_DISK_GET_STORAGEID_H
#include "main.h"
...
typedef class _IOCTL_DISK_GET_STORAGEID_TEST : public  DRIVER_TEST
{
...
public:
	_IOCTL_DISK_GET_STORAGEID_TEST(void){m_pKato = NULL;m_hDevice = NULL;dwDeviceType = 0;inData.dwIoControlCode = IOCTL_DISK_GET_STORAGEID;}
	_IOCTL_DISK_GET_STORAGEID_TEST(HANDLE Handle,CKato *pKato,DWORD deviceType){m_pKato = pKato;m_hDevice = Handle;dwDeviceType = deviceType;inData.dwIoControlCode = IOCTL_DISK_GET_STORAGEID;}
private:
	...
	DWORD m_ExpectedBytes;
}IOCTL_DISK_GET_STORAGEID_TEST,*PIOCTL_DISK_GET_STORAGEID_TEST;
#endif
