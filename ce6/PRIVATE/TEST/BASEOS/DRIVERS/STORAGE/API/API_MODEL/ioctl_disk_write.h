...
#ifndef _IOCTL_DISK_WRITE_H
#define _IOCTL_DISK_WRITE_H
#include "main.h"
...
typedef class _IOCTL_DISK_WRITE_TEST : public  DRIVER_TEST
{
...
public:
	_IOCTL_DISK_WRITE_TEST(void){m_pKato = NULL;m_hDevice = NULL;dwDeviceType = 0;inData.dwIoControlCode = IOCTL_DISK_WRITE;m_dataBuffer = NULL;}
	_IOCTL_DISK_WRITE_TEST(HANDLE Handle,CKato *pKato,DWORD deviceType){m_pKato = pKato;m_hDevice = Handle;dwDeviceType = deviceType;inData.dwIoControlCode = IOCTL_DISK_WRITE;m_dataBuffer = NULL;}
	~_IOCTL_DISK_WRITE_TEST(){if(m_dataBuffer)delete m_dataBuffer;m_dataBuffer = NULL;};
private:
...
}IOCTL_DISK_WRITE_TEST,*PIOCTL_DISK_WRITE_TEST;
#endif
