...
#ifndef _IOCTL_DISK_GETINFO_H
#define _IOCTL_DISK_GETINFO_H
#include "main.h"
#include "parameterfuncs.h"
#include "IoctlTestBase.h"

typedef class _IOCTL_DISK_GETINFO_TEST : public  DRIVER_TEST
{
...
public:
	_IOCTL_DISK_GETINFO_TEST(void){m_pKato = NULL;m_hDevice = NULL;dwDeviceType = 0;inData.dwIoControlCode = IOCTL_DISK_GETINFO;}
	_IOCTL_DISK_GETINFO_TEST(HANDLE Handle,CKato *pKato,DWORD deviceType){m_pKato = pKato;m_hDevice = Handle;dwDeviceType = deviceType;inData.dwIoControlCode = IOCTL_DISK_GETINFO;}
private:
...
}IOCTL_DISK_GETINFO_TEST,*PIOCTL_DISK_GETINFO_TEST;
#endif
