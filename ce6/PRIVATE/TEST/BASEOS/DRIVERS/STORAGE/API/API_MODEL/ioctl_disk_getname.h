...
#ifndef _IOCTL_DISK_GETNAME_H
#define _IOCTL_DISK_GETNAME_H
#include "main.h"
...
typedef class _IOCTL_DISK_GETNAME_TEST : public  DRIVER_TEST
{
...
public:
	_IOCTL_DISK_GETNAME_TEST(void){m_pKato = NULL;m_hDevice = NULL;dwDeviceType = 0;inData.dwIoControlCode = IOCTL_DISK_GETNAME;}
	_IOCTL_DISK_GETNAME_TEST(HANDLE Handle,CKato *pKato,DWORD deviceType){m_pKato = pKato;m_hDevice = Handle;dwDeviceType = deviceType;inData.dwIoControlCode = IOCTL_DISK_GETNAME;}
private:
...
}IOCTL_DISK_GETNAME_TEST,*PIOCTL_DISK_GETNAME_TEST;
#endif
