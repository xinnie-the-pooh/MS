...
TESTPROCAPI tst_IOCTL_DISK_WRITE(UINT uMsg,TPPARAM tpParam, 
...
BOOL IOCTL_DISK_WRITE_TEST::CustomCleanup()
{
	//cleanup
	if(m_dataBuffer)
	{
...
BOOL IOCTL_DISK_WRITE_TEST::CustomFill(void)
{
...
BOOL IOCTL_DISK_WRITE_TEST::LoadCustomParameters(void)
{
...
BOOL IOCTL_DISK_WRITE_TEST::RunIOCTL(void)
{
	BOOL retVal = TRUE;
	try
	{
...
BOOL IOCTL_DISK_WRITE_TEST::ATAPIValidate(void)
{
	BOOL retVal = TRUE;
...
BOOL IOCTL_DISK_WRITE_TEST::Validate(void)
{
