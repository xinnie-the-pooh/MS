...
void Debug(LPCTSTR szFormat, ...)
{
    ...
    // Platform Builder 5.01 seems to drop long strings in the Debug window.
    StringCchLength (szBuffer, countof(szBuffer), &nLength);
    if (nLength > 250)
    {
        StringCchCopy (szBuffer+250, 5, TEXT("..."));
    }
...
SHELLPROCAPI ShellProc(UINT uMsg, SPPARAM spParam)
{
    ...
    case SPM_STOP_SCRIPT:
        ...
        // when the script reaches its end, or because the user pressed{A4E7EDDA-E575-4252-9D6B-4195D48BB865}
