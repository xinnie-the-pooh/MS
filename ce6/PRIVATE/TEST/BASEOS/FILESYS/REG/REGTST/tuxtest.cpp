...
//  GLOBAL FLAGS that affect the behaviour of the whole test
DWORD   g_dwFlags;
DWORD   g_dwFailCount;


//  Predefined keys used in all test cases.
LPTSTR g_rgszKeyNames[] = {_T("RegPreBoot0"), 
						      _T("RegPreBoot1") 
};


//  Predefined values that are used by all test cases. 
//  WARNING : Changing these key names will affect other functions.
LPTSTR  g_rgszValueNames[] = {_T("StringVal"),
							   _T("DwordVal"),
							   _T("BinVal"),
							   _T("MultiSz_Val"), 
							   _T("BigEndian_Val"), 
...
void Debug(LPCTSTR szFormat, ...)
{
	...
	StringCchCopy(szBuffer, 1024, szHeader);
	StringCchVPrintf(
	...
	StringCchCat (szBuffer, 1024, TEXT("\r\n"));
