...
class CPolylineTestSuite : public CTestSuite
{
    public:
        CPolylineTestSuite(CSection * Section) : CTestSuite(Section), 
                                            ...
                                            { g_pCOtakLog->Log(OTAK_VERBOSE, TEXT("In CPolylineTestSuite overloaded constructor.")); }
         ~CPolylineTestSuite() { g_pCOtakLog->Log(OTAK_VERBOSE, TEXT("In CPolylineTestSuite destructor.")); }
...
private:
        CPolylineTestSuite() { g_pCOtakLog->Log(OTAK_VERBOSE, TEXT("In CPolylineTestSuite base constructor.")); }
