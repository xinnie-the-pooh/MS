...
struct Stream {
    ...
    BYTE                    bLocalSeid;     // Local SEID
    BYTE                    bRemoteSeid;    // Remote SEID
    ...
    Stream(BYTE LocalSeid, BYTE RemoteSeid, HANDLE Owner, HANDLE SessSignal)
    {
        hOwner = Owner;
        hContext = NULL;
        ...
        bLocalSeid = LocalSeid;        
        bRemoteSeid = RemoteSeid;
